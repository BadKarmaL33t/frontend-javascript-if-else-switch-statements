...
// ==========================================
const wordIsEqualTo = "zoet" === "sappig";
console.log(isEqualTo);
// ==========================================
...
if (grade > 8) {
    console.log("Cum laude"); }
        ...
        console.log('Your grade is 8 or lower');
}
// ==========================================
...
if (isRaining === false && temperature > 21) {
    ...
    console.log("Kijk buiten welke kleding geschikt is voor het huidige weer");
}
